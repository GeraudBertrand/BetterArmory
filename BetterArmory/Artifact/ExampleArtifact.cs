...
namespace BetterArmory.Artifact
{
    class ExampleArtifact : ArtifactBase
    {
        ...
        public override Sprite ArtifactEnabledIcon => MainAssets.LoadAsset<Sprite>("assets/textures/icons/item/littleplate_icon.png");

        public override Sprite ArtifactDisabledIcon => MainAssets.LoadAsset<Sprite>("assets/textures/icons/item/littleplate_icon.png");
